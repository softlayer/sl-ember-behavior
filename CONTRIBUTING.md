...
This is the issue tracker for `sl-ember-behavior`. The community uses this site to collect and track bugs and discussions of
new features. If you are having difficulties using `sl-ember-behavior` or have a question about usage please ask a question
on Stack Overflow: http://stackoverflow.com/questions/ask?tags=sl-ember-behavior
...
4. Your issue will be verified. The provided demo will be tested for correctness. The sl-ember-behavior team will work with you until your issue can be verified.

5. Keep up to date with feedback from the sl-ember-behavior team on your ticket. Your ticket may be closed if it becomes stale.
